...
function App() 
{
  ...
  return (
    <>
      {isFetching && <h1>fffffffffffffffffff</h1>}
      {!isFetching && (
        <>
          ...
          <div className="hero-about">
            <section className="hero-about__section">
              ...
              <p className="hero-about__text">
                Soy un estudiante de ingenieria de sistemas en la universidad
                UPN a fines, actualmente busco experiencia como desarrollador
                web.
              </p>
            </section>
            <section className="hero-about__section">
